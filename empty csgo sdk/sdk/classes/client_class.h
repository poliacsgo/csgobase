...
namespace sdk {
	namespace classes {
		// https://github.com/pmrowla/hl2sdk-csgo/blob/master/public/client_class.h
		...
		typedef client_networkable* ( *create_client_class_fn )( std::int32_t ent_number, std::int32_t serial_number );
